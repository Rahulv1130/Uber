...
const ConfirmRide = ({ setVehiclePanelOpen, setConfirmRidePanel, setFindingDriverPanel, createRide, 
    fare, vehicleType, pickupFirstAddress, destinationFirstAddress, pickup, destination }) => {
    ...
    return (
        <div>
            ...
            <h5 onClick={() => { setConfirmRidePanel(false); setVehiclePanelOpen(true); }} className=" w-full text-center p-1">
                <i className="text-gray-300 text-3xl ri-arrow-down-wide-line"></i>
            </h5>

            <h3 className="text-2xl font-semibold pl-3">Confirm your ride</h3>
            ...
            <div className="flex flex-col justify-center items-center gap-2 p-5">
                ...
                <button onClick={()=> { createRide(); setFindingDriverPanel(true); setConfirmRidePanel(false) }} className="bg-green-600 mt-5 w-full font-semibold text-white p-2 rounded-lg">Confirm</button>
            </div>
